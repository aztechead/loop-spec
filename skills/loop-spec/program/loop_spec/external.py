...
POSTCONDITION_TEXT: dict[str, str] = {
    ...
    "V3": "every evidence SHA equals the verified head",
    ...
    "V7": "every verdict is pass and the review policy holds: first and final passes saw the full diff, other passes the delta since the last reviewed SHA, no Critical finding open",
    ...
    "I1": "product validates; the verdict binds the integrated SHA, the requirements revision, and the plan revision",
    "I2": "every gap names a target of SPEC, PLAN, EXECUTE, or VERIFY",
    "I3": "T1 holds for this rewind",
    "I4": "a rewind is needed and T1 refuses it, or a criterion or goal gap is open that no route can close",
