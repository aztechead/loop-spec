...
POSTCONDITION_TEXT: dict[str, str] = {
    ...
    "E9": "start..head is empty, where start is the base, or the adopted PR's head in its own repo, and every task is already-satisfied or removed",
    ...
    "D6": "on a no change EXECUTE every row is skipped with no deliveredSha; only the adopted repo's row names a PR, the adopted PR, at the verified head, and gh pr view shows it open at that head",
