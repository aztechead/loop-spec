...
| Surface | File |
|---|---|
| SPEC Foundations round (greenfield) and design grill | `skills/spec/SKILL.md`, `skills/spec/references/interview-prompts.md`, `agents/spec-writer.md` |
| PLAN | `skills/plan/SKILL.md`, `agents/planner.md`, `skills/shared/artifact-templates/PLAN.md.template` |
