# Advocate spawn template — not dispatched

<!-- Usage: do not spawn advocate-{N}. Critique is challenger-only
     (skills/shared/tier-matrix.md). This file is retained so older feature dirs
     that name it still resolve; it is never a spawn brief. -->
<!-- Placeholders: {slug}, {N} -->
