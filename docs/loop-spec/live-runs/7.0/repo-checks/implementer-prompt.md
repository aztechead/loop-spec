...
```json
{
  ...
  "dependsOn": [],
  "featureAdded": "tests/test_temperature.py",
  "files": [
    "unitkit/temperature.py",
    "tests/test_temperature.py"
  ],
  "id": "T-1",
  "mustFlip": false,
  "repo": "checks-cli",
  "title": "Add unitkit/temperature.py with celsius/fahrenheit conversions and tests",
  "verify": "uv run pytest -q tests/test_temperature.py"
}
```
...
## Output
Write ONE JSON file to /Users/aztechead/.claude/plugins/data/loop-spec-inline/bb5ffda5c5eee554/add-unitkit-temperature-py-with-celsius/.loop-spec/results/add-unitkit-temperature-py-with-celsius/T-1-implement-1.json matching this schema:
```json
{
...
```
Working directory: /Users/aztechead/.claude/plugins/data/loop-spec-inline/bb5ffda5c5eee554/add-unitkit-temperature-py-with-celsius/worktrees/T-1. Do not write anywhere else except the working directory.
--- loop-spec step ---
step: step-e18ab77b53b3
inputs: sha256:8389303d1fc2b6c3682a816cda0acf8c8ccc3728d2182481d714cc38216ab67e
phase: execute
result: /Users/aztechead/.claude/plugins/data/loop-spec-inline/bb5ffda5c5eee554/add-unitkit-temperature-py-with-celsius/.loop-spec/results/add-unitkit-temperature-py-with-celsius/T-1-implement-1.json
