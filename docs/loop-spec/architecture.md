...
- [superpowers](https://github.com/obra/superpowers): a curated bundle of skills that turns Claude Code into a disciplined collaborator. Its lesson here: skills are how you encode workflow. A four-month scan of v5.1.0–v6.3.0 (identification only; nothing ported yet) is in [superpowers-scan-proposals.md](superpowers-scan-proposals.md).
