...
- /super-spec:pause + lib/pause-snapshot.sh (HANDOFF.json + .continue-here.md)
- /super-spec:forensics (7-pattern read-only diagnostic)
- Regression gate in skills/verify (advisory pre-VERIFY)
- /super-spec:rollback + lib/checkpoint.sh (6 checkpoint types, git-tag based)
...
- discipline-inject hook + /super-spec:discipline skill (SessionStart)
