...
- **Three questions (design gate — on by default).** Before implementing and again before DONE, ask of the change: can I make it more modular? can I make it more extensible? is this the least amount of code that makes it happen? Full contract: `skills/shared/implementer-contract.md`.
