...
checks=(
  ...
  $'hooks/team/result-forgery-guard.sh\tbash $lib_dir/feature-write.sh set <feature_dir> <dot.path>'
  ...
  $'lib/dispatch-files.sh\tDo not read SPEC.md, PLAN.md, or EVIDENCE.md'
