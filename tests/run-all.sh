...
run_suite "dispatch-read-set"         "bash tests/dispatch-read-set.test.sh"
...
run_suite "tests/spec-grill-coverage" "bash tests/spec-grill-coverage.test.sh"
...
run_suite "lib/loop-log" "bash tests/lib/loop-log.test.sh"
