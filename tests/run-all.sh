...
run_suite "hooks/team/placeholder-question-guard" "bash hooks/team/placeholder-question-guard.test.sh"
...
run_suite "lib/execution-inputs"      "bash tests/lib/execution-inputs.test.sh"
run_suite "lib/execution-observation" "bash tests/lib/execution-observation.test.sh"
...
run_suite "lib/implicit-team-model"   "bash tests/lib/implicit-team-model.test.sh"
...
run_suite "lib/portability-scan"      "bash tests/lib/portability-scan.test.sh"
...
run_suite "lib/adopt-pr"              "bash tests/lib/adopt-pr.test.sh"
...
run_suite "hooks/team/cycle-stamp-guard"   "bash hooks/team/cycle-stamp-guard.test.sh"
...
run_suite "lib/dispatch-files"        "bash tests/lib/dispatch-files.test.sh"
run_suite "lib/fix-loop"              "bash tests/lib/fix-loop.test.sh"
run_suite "lib/prejudge-lint"         "bash tests/lib/prejudge-lint.test.sh"
...
run_suite "hooks/team/result-forgery-guard" "bash hooks/team/result-forgery-guard.test.sh"
...
run_suite "lib/plan-render"           "bash tests/lib/plan-render.test.sh"
run_suite "lib/artifact-lint"         "bash tests/lib/artifact-lint.test.sh"
run_suite "lib/requirements"         "bash tests/lib/requirements.test.sh"
run_suite "lib/requirements-migrate" "bash tests/lib/requirements-migrate.test.sh"
...
run_suite "lib/doc-deps"              "bash tests/lib/doc-deps.test.sh"
...
run_suite "lib/review-routing" "bash tests/lib/review-routing.test.sh"
run_suite "lib/cycle-launch" "bash tests/lib/cycle-launch.test.sh"
run_suite "lib/phase-snapshot" "bash tests/lib/phase-snapshot.test.sh"
run_suite "lib/spec-intent" "bash tests/lib/spec-intent.test.sh"
run_suite "lib/publication-callers" "bash tests/lib/publication-callers.test.sh"
run_suite "release-7-0-coverage" "bash tests/release-7-0-coverage.test.sh"
run_suite "tests/all-tests-registered" "bash tests/all-tests-registered.test.sh"
run_suite "tests/hook-payload-stdin" "bash tests/hook-payload-stdin.test.sh"
...
run_suite "tests/output-style-coverage" "bash tests/output-style-coverage.test.sh"
run_suite "tests/discuss-grill-coverage" "bash tests/discuss-grill-coverage.test.sh"
run_suite "tests/spec-plan-speed-coverage" "bash tests/spec-plan-speed-coverage.test.sh"
run_suite "tests/tdd-red-green-coverage" "bash tests/tdd-red-green-coverage.test.sh"
