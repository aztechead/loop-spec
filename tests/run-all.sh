...
run_suite "hooks/team/busy-wait-guard" "bash hooks/team/busy-wait-guard.test.sh"
...
run_suite "hooks/team/secret-guard" "bash hooks/team/secret-guard.test.sh"
...
run_suite "lib/fixlist-route"           "bash tests/lib/fixlist-route.test.sh"
run_suite "lib/verify-lint"           "bash tests/lib/verify-lint.test.sh"
