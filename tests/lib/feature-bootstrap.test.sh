...
make_repo "$WORK/n"
compact_classification='{"route":"compact","candidateRoute":"compact","taskKind":"refactor","confidence":0.8,"estimatedFiles":3,"reviewableEstimatedFiles":3,"criteriaCount":2,"ambiguity":"medium","introducesSeam":false,"introducesDependency":false,"introducesNewDependency":false,"updatesDependencyVersion":false,"changesInterface":false,"securitySensitive":false,"dataMigration":false,"multiRepo":false,"destructive":false,"workingTreeConflict":false,"reason":"bounded change","gatePlan":{"specInterview":{"run":false,"reason":"bounded change"},"specCritique":{"run":false,"reason":"gated spec"},"planCritique":{"run":true,"reason":"plan touches a seam"},"repositoryValidation":{"run":true,"reason":"candidate validation"},"placeholderScan":{"run":true,"reason":"safety scan"},"tamperScan":{"run":true,"reason":"safety scan"},"acceptance":{"run":true,"reason":"criterion evidence"},"codeReview":{"run":false,"reason":"bounded diff"},"iterate":{"run":false,"reason":"classifier convergence"}}}'
