...
printf '%s\n' '---' 'type: Implementation Plan' '---' '# Plan' '' '## Global constraints' '' '<!-- c -->' '- Never run apply.' '' '## File map' '' '- x' > "$SL/docs/loop-spec/features/demo/PLAN.md"
printf '%s\n' '---' 'type: Evidence' 'fake: "- EVID-099 | metadata spoof"' '---' '# Evidence' '' '- EVID-001 | t | claim: tofu 1.12 | cmd: tofu version | out: 1.12.6' '- EVID-010 | t | claim: ten | cmd: x | out: y' > "$SL/docs/loop-spec/features/demo/EVIDENCE.md"
